		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Interinvoicing Admin",
									"targetURL": "#comnnfinanceinterinvoicingadmin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnnfinanceinterinvoicingadmin-display": {
								"semanticObject": "comnnfinanceinterinvoicingadmin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nn.finance.interinvoicingadmin",
									"url": sap.ui.require.toUrl("com/nn/finance/interinvoicingadmin")
								}
							}
						}
					}
